...
static seg_dev_t seg_dev = {
	.tempAndHumidity = {
		.tens = {0, 1, 2, 3, 4, 5, 6},
		.units = {7, 8, 9, 10, 11, 12, 13},
		.t_unit_id = 15,
		.h_unit_id = 14,
	},
	.seg_time = {
		.seg_hour_tens = {17, 18, 19, 20, 21, 22, 23},
		.seg_hour_units = {24, 25, 26, 27, 28, 29, 30},
		.seg_units = 31,
		.seg_minute_tens = {32, 33, 34, 35, 36, 37, 38},
		.seg_minute_units = {39, 40, 41, 42, 43, 44, 45},
	},
};
// 数码管显示颜色定义
